...
namespace Assignment5.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Artist,Genre,Price,ReleaseDate")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Artist,Genre,Price,ReleaseDate")] Song song)
        {
            if (id != song.Id)
            {
                return NotFound();
